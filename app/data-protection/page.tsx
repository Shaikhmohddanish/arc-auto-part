        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            <div className="bg-card rounded-lg p-8 shadow-sm border space-y-6">
              <section>
                <h2 className="text-2xl font-semibold text-foreground mb-4">GDPR Privacy Policy for ARC Auto Part</h2>
                <p className="text-muted-foreground leading-relaxed">
                  At ARC Auto Part, accessible from arcautopart.com, one of our main priorities is the privacy of our
                  visitors. This Privacy Policy document contains types of information that is collected and recorded by
                  ARC Auto Part and how we use it. If you have additional questions or require more information about
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  We are a Data Controller of your information. ARC Auto Part legal basis for collecting and using the
                  personal information described in this Privacy Policy depends on the Personal Information we collect
                  and the specific context in which we collect the information:
                </p>
                <ul className="list-disc list-inside space-y-2 text-muted-foreground">
                  <li>ARC Auto Part needs to perform a contract with you</li>
                  <li>You have given ARC Auto Part permission to do so</li>
                  <li>Processing your personal information is in ARC Auto Part legitimate interests</li>
                  <li>ARC Auto Part needs to comply with the law</li>
                </ul>
                <p className="text-muted-foreground leading-relaxed mt-4">
                  ARC Auto Part will retain your personal information only for as long as is necessary for the purposes
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  ...
                  from our systems, please contact us. In certain circumstances, you have the following data protection
                  rights:
                </p>
                <div className="grid gap-4">
                  <div className="bg-muted rounded-lg p-4">
                    <h4 className="font-semibold text-foreground mb-2">The right to access</h4>
                    <p className="text-muted-foreground">Update or delete the information we have on you</p>
                  </div>
                  <div className="bg-muted rounded-lg p-4">
                    <h4 className="font-semibold text-foreground mb-2">The right of rectification</h4>
                    <p className="text-muted-foreground">Correct any information you believe is inaccurate</p>
                  </div>
                  <div className="bg-muted rounded-lg p-4">
                    <h4 className="font-semibold text-foreground mb-2">The right to object</h4>
                    <p className="text-muted-foreground">Object to our processing of your personal data</p>
                  </div>
                  <div className="bg-muted rounded-lg p-4">
                    <h4 className="font-semibold text-foreground mb-2">The right of restriction</h4>
                    <p className="text-muted-foreground">Request restriction of processing your personal data</p>
                  </div>
                  <div className="bg-muted rounded-lg p-4">
                    <h4 className="font-semibold text-foreground mb-2">The right to data portability</h4>
                    <p className="text-muted-foreground">Transfer your data to another organization</p>
                  </div>
                  <div className="bg-muted rounded-lg p-4">
                    <h4 className="font-semibold text-foreground mb-2">The right to withdraw consent</h4>
                    <p className="text-muted-foreground">Withdraw consent at any time</p>
                  </div>
                </div>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ARC Auto Part follows a standard procedure of using log files. These files log visitors when they
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Like any other website, arcautopart.com uses 'cookies'. These cookies are used to store information
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ARC Auto Part's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  parents and guardians to observe, participate in, and/or monitor and guide their online activity. Arm
                  Auto Parts does not knowingly collect any Personal Identifiable Information from children under the
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  regards to the information that they shared and/or collect in arcautopart.com. This policy is not
