            ...
            <div className="bg-card rounded-lg p-8 shadow-sm border space-y-6">
              <section>
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  ARC Auto Part and how we use it.
                </p>
                <p className="text-muted-foreground leading-relaxed">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  with regards to the information that they shared and/or collect in ARC Auto Part. This policy is not
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Like any other website, ARC Auto Part uses 'cookies'. These cookies are used to store information
              ...
              <section>
                <h2 className="text-2xl font-semibold text-foreground mb-4">GDPR Data Protection Rights</h2>
                <p className="text-muted-foreground leading-relaxed mb-4">
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ARC Auto Part does not knowingly collect any Personal Identifiable Information from children under
